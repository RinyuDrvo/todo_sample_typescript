...
// propsからnamespaceを作る時に使用する関数
export var createNamespacedFnHelpers = function (namespaceFn: () => string) {
  return ({
    // 各関数にバインド
...
export var mapState = function (namespaceFn: () => string, states: any) {
  var res: any = {};
  normalizeMap(states).forEach(function (ref: any) {
    var key = ref.key;
    var val = ref.val;
...
export var mapGetters = function (namespaceFn: () => string, getters: any) {
  var res: any = {};
  normalizeMap(getters).forEach(function (ref: any) {
    var key = ref.key;
...
export var mapActions = function (namespaceFn: () => string, actions: any) {
  var res: any = {};
  normalizeMap(actions).forEach(function (ref: any) {
    var key = ref.key;
    var val = ref.val;
    res[key] = function mappedAction() {
      var args = [], len = arguments.length;
      while (len--) args[len] = arguments.length;
...
export var mapMutations = function (namespaceFn: () => string, mutations: any) {
  var res: any = {};
  normalizeMap(mutations).forEach(function (ref: any) {
    var key = ref.key;
    var val = ref.val;
